                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item active">
                            <a class="nav-link text-white" href="{{ route('admin.dashboard') }}">สรุป</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link text-white" href="{{ route('admin.category.index') }}">ประเภทสินค้า</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link text-white" href="{{ route('admin.product.index') }}">สินค้า</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link text-white" href="{{ route('admin.order.index') }}">ออเดอร์</a>
                        </li>
                        <li class="nav-item active">
                            <a class="nav-link text-white" href="{{ route('admin.review.index') }}">รีวิว</a>
                        </li>
                    </ul>
                ...
                <div class="row justify-content-center">
                    <!-- <div class="col-md-2">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item list-group-item-action">
                                <a href="{{ route('admin.order.index') }}">ออเดอร์</a>
                            </li>
                        </ul>
                    </div> -->
                    <div class="col-md-8">
